...
<div class="wpv-config-row font clearfix <?php echo $class ?>">
	...
	<div class="rcontent">
		...
		<div class="font-preview"><?php _e('The quick brown fox jumps over the lazy dog', 'honeymoon')?></div>
		...
		<span class="wrapper size-wrapper <?php echo $show->size?>">
			...
			<div class="sub-desc"><?php _e('font size', 'honeymoon')?></div>
		</span>
		...
		<span class="wrapper lheight-wrapper <?php echo $show->lheight?>">
			...
			<div class="sub-desc"><?php _e('line height', 'honeymoon')?></div>
		</span>
		...
		<span class="wrapper face-wrapper <?php echo $show->face?>">
			...
			<div class="sub-desc"><?php _e('font', 'honeymoon')?></div>
		</span>
		...
		<span class="wrapper weight-wrapper <?php echo $show->weight?>">
			...
			<div class="sub-desc"><?php _e('style', 'honeymoon')?></div>
		</span>
		...
		<span class="wrapper color-wrapper <?php echo $show->color?>">
			...
			<div class="sub-desc"><?php _e('color', 'honeymoon')?></div>
		</span>
	</div>
</div>