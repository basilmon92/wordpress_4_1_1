...
$contexts = array(
	'post'      => __('Post', 'honeymoon'),
	'page'      => __('Page', 'honeymoon'),
	'portfolio' => __('Portfolio', 'honeymoon'),
	'product'   => __('Product', 'honeymoon'),
	'lightbox'  => __('Lightbox', 'honeymoon'),
	'tribe'     => __('Tribe Events', 'honeymoon'),
);
