...
class WpvSidebars {
	...
	public function __construct() {
		$this->sidebars = array(
			'page' => __( 'Shared Page Widget Area', 'honeymoon' ),
			'blog' => __( 'Blog Widget Area', 'honeymoon' ),
			'portfolio' => __( 'Portfolio Widget Area', 'honeymoon' ),
		);

		if ( wpv_has_woocommerce() )
			$this->sidebars['wpv-woocommerce'] = __( 'WooCommerce Widget Area', 'honeymoon' );
