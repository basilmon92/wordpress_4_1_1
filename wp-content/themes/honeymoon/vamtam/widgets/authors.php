...
class wpv_authors extends WP_Widget {
	...
	public function wpv_authors() {
		$widget_opts = array(
			...
			'description' => __('List of authors and their descriptions', 'honeymoon')
			);
		$this->WP_Widget('wpv_authors', __('Vamtam - Authors', 'honeymoon'), $widget_opts);
	}
	...
	public function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Authors', 'honeymoon') : $instance['title'], $instance, $this->id_base);
