...
?>
		<li>
			<a href="<?php echo $link?>" rel="nofollow" target="_blank" title="<?php echo esc_attr($name)?>">
				<span class="icon before" data-icon-type="<?php echo $icon?>"><?php wpv_icon($icon)?></span><span class="content"><?php echo $name?></span><span class="icon after"><?php wpv_icon('arrow-right1') ?></span>
			</a>
		</li>
<?php endfor ?>
</ul>
