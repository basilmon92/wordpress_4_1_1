		...
		<div class="wpv-grid grid-1-4 <?php if($i % 4 !== 0) echo 'left-border' ?>">
			<div class="event-wrapper">
				...
				<div class="when-where">
					<div><?php echo $stime ?> &mdash; <?php echo $etime ?></div>
					<div>@ <?php
				...
				<a href="<?php tribe_event_link($event) ?>" title="<?php esc_attr_e('Read More', 'honeymoon') ?>" class="button button-border accent1 hover-accent1"><span class="btext"><?php _e('Read More', 'honeymoon') ?></span></a>
			</div>
		</div>
