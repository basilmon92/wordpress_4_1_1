...
return array(
array(
	'name' => __('Purchase', 'honeymoon'),
	'type' => 'start'
),

array(
	'name' => __('Why do you need this information?', 'honeymoon'),
	'desc' => __('Filling these fields allows us to implement automatic updates for your Vamtam theme. Your theme will still be working if you leave these options empty, although you will have to install updates manually.<br>
		...
		Please note that any modifications made to the theme files will be overwritten after an automatic update, if you do not have a child theme enabled. Your theme options and content will be preserved.', 'honeymoon'),
	'type' => 'info',
),

array(
	'name' => __('Your Envato Username', 'honeymoon') ,
	'id' => 'envato-username',
	'type' => 'text',
	'static' => true,
) ,
...
array(
	'name' => __('Your Envato API Key', 'honeymoon') ,
	'desc' => sprintf(__('Do not share your API key with people you can\'t trust! Your API key gives them access to your purchased items. <a href="%s">See this page for a description of the Envato API and how to obtain an API key.</a>', 'honeymoon'), 'http://extras.envato.com/api/'),
	'id' => 'envato-api-key',
	'type' => 'text',
	'static' => true,
) ,
...
array(
	'name' => __( 'Validate Purchase Information', 'honeymoon' ),
	'desc' => __( 'Please be aware that without this information you can\'t use the automatic update feature. Updating using FTP is only for advanced users and you can’t update the bundled with the theme plugins using FTP method.', 'honeymoon' ),
	'title' => __( 'Check', 'honeymoon' ),
	'link' => '#',
	'type' => 'button',
	'data' => array(
...
<h5>Support</h5>
 If you have any questions that are beyond the scope of this help file, please feel free to <a href="%s">email us</a> or open a ticket in our <a href="%s">Help Desk</a>. You can <a href="%s">follow us on twitter</a> to get the updates. Thanks so much!', 'honeymoon'), 'http://themeforest.net/licenses', 'mailto:support@vamtam.com', 'http://support.vamtam.com', 'https://twitter.com/vamtam' ),
	),
	'button_class' => 'vamtam-check-license',
),

array(
	'name' => __('Disable System Status Information Gathering', 'honeymoon'),
